...
public class RehomeRequest {
    ...
    private String photoBase64; // base64 data-URL of the pet photo
    ...
    public void setPhotoBase64(String v) {
        this.photoBase64 = v;
    }

    public String getIdealHomeDesc() {
        return idealHomeDesc;
    }

    public void setIdealHomeDesc(String v) {
        this.idealHomeDesc = v;
    }
    ...
    public void setBehaviorOther(String v) {
        this.behaviorOther = v;
    }
    ...
    public void setGoodWithPets(Boolean v) {
        this.goodWithPets = v;
    }
    ...
    public void setIsHouseTrained(Boolean v) {
        this.isHouseTrained = v;
    }

    public Boolean getIsLeashTrained() {
        return isLeashTrained;
    }

    public void setIsLeashTrained(Boolean v) {
        this.isLeashTrained = v;
    }
    ...
    public void setVaccineType(String v) {
        this.vaccineType = v;
    }
    ...
    public void setAnimalName(String v) {
        this.animalName = v;
    }
    ...
    public void setRejectNote(String v) {
        this.rejectNote = v;
    }
