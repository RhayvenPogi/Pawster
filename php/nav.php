...
/* =============================================
   ...
   nav.php  — include at top of every page
   Usage:
     $activePage = 'home'; // home|pets|how|rehome|missing|about
...
<nav>
  <div class="nav-inner">
    ...
    <ul class="nav-links" id="nav-links">
      ...
      <li><a href="missing.php"      <?= $activePage==='missing'?'class="active"':'' ?>><i class="fas fa-search-location"></i> Missing Pets</a></li>
