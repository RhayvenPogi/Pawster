...
<div class="page-hero" style="background:linear-gradient(135deg,#8a3010,var(--c2))">
      ...
      <div id="rehome-form-wrap">
        <form id="rehome-form" onsubmit="submitRehome(event)">
          <div class="form-grid" style="gap:1rem">
            <div class="form-field full" style="margin-bottom:0.2rem">
            ...
            <div class="form-field full" style="margin-top:0.8rem;margin-bottom:0.2rem">
            ...
            <div class="form-field full"><label>Reason for Rehoming *</label>
              <textarea id="rh-reason" required placeholder="Please explain your situation. Be as detailed as possible so we can help find the best match…"></textarea>
            </div>
            <div class="form-field full"><label>Pet's Temperament</label>
              <textarea id="rh-temp" placeholder="Describe your pet's personality, behaviour, what they like/dislike, any special needs…" style="min-height:80px"></textarea>
            </div>
