...
<div class="page-wrap">
  ...
  <div style="margin-top:3rem">
    ...
    <div class="faq-list">
      ...
      <div class="faq-item reveal glass-card" style="transition-delay:<?= $i*0.08 ?>s">
  ...
  <div style="text-align:center;margin-top:4rem;padding:3rem 2rem;background:var(--surface);backdrop-filter:blur(14px);border:1.5px solid var(--border);border-radius:var(--radius);box-shadow:var(--shadow)" class="reveal">
    ...
    <a href="find_a_pet.php" class="btn-primary" style="margin:0 auto;display:inline-flex"><i class="fas fa-search"></i> Browse Animals</a>
  </div>
