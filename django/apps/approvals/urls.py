...
urlpatterns = [
    ...
    path("adoptions/user/",              views.user_adoptions,   name="user_adoptions"),
    path("adoptions/<int:pk>/",          views.adoption_detail,  name="adoption_detail"),
    ...
    path("rehoming/user/",               views.user_rehoming,    name="user_rehoming"),
    path("rehoming/<int:pk>/",           views.rehoming_detail,  name="rehoming_detail"),
