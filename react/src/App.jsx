...
function AppInner() {
  ...
  const hideNavbar = ['/', '/landing', '/login', '/register', '/forgot-password', '/admin', '/complete-profile'].includes(location.pathname);
    ...
    <>
      ...
      <Routes>
        ...
        <Route
          ...
          element={
            // Must be authenticated but NOT wrapped in ProtectedRoute
            // (ProtectedRoute would redirect them back here in a loop)
            user
              ? <CompleteProfilePage />
